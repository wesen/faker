  ...
  describe(`random seeded tests for seed ${JSON.stringify(
    ...
    describe('amount()', () => {
      it('should use the default amounts when not passing arguments', () => {
        ...
        expect(+amount, 'the amount should be greater than 0').toBeGreaterThan(
          0
        );
      ...
      it('it should return a string', () => {
        ...
        expect(amount).toBeTruthy();
        expect(amount, 'the amount type should be string').toBeTypeOf('string');
      });
    ...
    describe('creditCardNumber()', () => {
      ...
      it('should return a valid credit card number', () => {
        ...
        expect(faker.finance.creditCardNumber('discover')).toSatisfy(luhnCheck);
        expect(faker.finance.creditCardNumber()).toSatisfy(luhnCheck);
        expect(faker.finance.creditCardNumber()).toSatisfy(luhnCheck);
      });
